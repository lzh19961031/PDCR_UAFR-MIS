...
def main():
    ...
    #print('get_default_configuration' , network, task, network_trainer, plans_identifier)
    ...
    #print(trainer.save_best_checkpoint)
    ...
    if args.disable_saving:
        ...
        trainer.save_best_checkpoint = True  # whether or not to save the best checkpoint according to self.best_val_eval_criterion_MA
